  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      if (error.code === 'auth/unauthorized-domain') {
        setErrorMsg("This domain is not authorized. Please add your Vercel URL to Firebase Console > Authentication > Settings > Authorized domains.");
      } else {
    ...
    <div className="min-h-[80vh] flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-[40px] p-10 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          {errorMsg && (
            <div className="mb-6 p-4 bg-red-900/20 border border-red-500/30 rounded-2xl text-red-400 text-xs font-bold leading-relaxed animate-in fade-in slide-in-from-top-2">
              {errorMsg}
            </div>
          )}
